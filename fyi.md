...
| `chat_session` | model, system_prompt, provider, ... |
| `chat_session_anthropic` | model, system_prompt, ... |
| `chat_session_ollama` | model, system_prompt, ... |
| `chat_session_openai` | model, system_prompt, ... |
...
- **`model`**: Character. Model name.
- **`system_prompt`**: Character or NULL. System prompt.
- **`provider`**: Character. Provider: "openai", "anthropic", "ollama".
